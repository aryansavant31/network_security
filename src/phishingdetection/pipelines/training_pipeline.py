from src.phishingdetection.components.data_ingestion.train import DataIngestionComponent
from src.phishingdetection.components.data_validation.train import DataValidationComponent
from src.phishingdetection.components.data_transformation import DataTransformationComponent
from src.phishingdetection.components.model_trainer import ModelTrainerComponent
from src.phishingdetection.manager.training_pipeline.configuration import ConfigurationManager
...
from src.phishingdetection.entity.training_pipeline.config_entity import TrainingPipelineConfig
from src.phishingdetection.entity.training_pipeline.artifact_entity import (DataIngestionArtifact, DataValidationArtifact, 
                                                    DataTransformationArtifact, ModelTrainerArtifact)
from src.phishingdetection.cloud.s3_syncer import S3Sync
from src.phishingdetection.constants.training_pipeline import AWS_BUCKET_NAME, ARTIFACT_DIR_NAME, FINAL_MODEL_DIR
import sys
import os

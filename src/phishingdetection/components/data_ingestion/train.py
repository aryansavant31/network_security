...
from src.phishingdetection.entity.training_pipeline.config_entity import DataIngestionConfig
from src.phishingdetection.entity.training_pipeline.artifact_entity import DataIngestionArtifact

import os
from src.phishingdetection.constants import (training_pipeline)
from src.phishingdetection.constants.training_pipeline import model_trainer
from src.phishingdetection.constants.training_pipeline import data_ingestion, data_transformation, data_validation
from src.phishingdetection.utils.common import read_yaml, create_directories
from src.phishingdetection.entity.training_pipeline.config_entity import (DataIngestionConfig, DataValidationConfig, 
...
class ConfigurationManager:
    def __init__(self, 
                 ...
                 config_path=training_pipeline.CONFIG_FILE_PATH,
                 ):
        self.training_pipeline_config = training_pipeline_config
        self.config = read_yaml(path_to_yaml=config_path)
        self.artifact_root = self.training_pipeline_config.artifact_path

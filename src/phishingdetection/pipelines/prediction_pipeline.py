...
import sys
from src.phishingdetection.entity.prediction_pipeline.config_entity import (PredictionPipelineConfig, 
                                                                      DataIngestionConfig,
                                                                      DataValidationConfig,
                                                                      ModelPredictorConfig)
from src.phishingdetection.manager.prediction_pipeline.configuration import ConfigurationManager
from src.phishingdetection.exceptions.custom_exception import NetworkSecurityException
from src.phishingdetection.components.data_ingestion.predict import DataIngestionComponent
from src.phishingdetection.components.data_validation.predict import DataValidationComponent
from src.phishingdetection.components.model_predictor import ModelPredictorComponent
from src.phishingdetection.entity.prediction_pipeline.artifact_entity import (DataIngestionArtifact, DataValidationArtifact)
from src.phishingdetection.cloud.s3_syncer import S3Sync
from src.phishingdetection.constants.prediction_pipeline import AWS_BUCKET_NAME, ARTIFACT_DIR_NAME
import pandas as pd

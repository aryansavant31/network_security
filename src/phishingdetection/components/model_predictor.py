from src.phishingdetection.entity.prediction_pipeline.artifact_entity import DataValidationArtifact
from src.phishingdetection.entity.prediction_pipeline.config_entity import ModelPredictorConfig

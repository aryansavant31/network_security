...
from src.phishingdetection.entity.prediction_pipeline.config_entity import DataIngestionConfig
from src.phishingdetection.entity.prediction_pipeline.artifact_entity import DataIngestionArtifact
from src.phishingdetection.components.data_ingestion import DataIngestionComponentTools
import os
import sys
import pandas as pd
